...
//    };
    ...
    //TODO
    public static ArrayList<Estabelecimento> selectEstabelecimentoByAdmin(String userID) {
        ArrayList<Estabelecimento> arrayListEstabelecimento = new ArrayList<>();
        for (Estabelecimento e : estabelecimentos) {
            if (Objects.equals(e.getmIdAdministrador(), userID)) {
                arrayListEstabelecimento.add(e);
            }
        }
        return arrayListEstabelecimento;
    ...
    //TODO
    public static Estabelecimento selectEstabelecimento(String id) {
        for (Estabelecimento e : estabelecimentos) {
            if (Objects.equals(e.getmId(), id)) {
                return e;
            }
        }
        return null;
    ...
    public static Estabelecimento createEstabelecimento(Estabelecimento in) {
        ...
        assert in != null;
        Estabelecimento newEst = new Estabelecimento(
